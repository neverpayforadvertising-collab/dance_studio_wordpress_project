...
if ( ! class_exists( 'Museum_Exhibition_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Museum_Exhibition_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$museum_exhibition_contents = wp_remote_retrieve_body( $response );

			return $museum_exhibition_contents;
		}
...
if ( ! function_exists( 'museum_exhibition_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function museum_exhibition_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Museum_Exhibition_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'museum_exhibition_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function museum_exhibition_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Museum_Exhibition_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
